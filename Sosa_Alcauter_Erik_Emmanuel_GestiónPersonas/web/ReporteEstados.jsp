...
<html>
    ...
    <center><body>
            ...
            <table border="1">
                <thead>
                    <tr>
                        <td>Estado</td>  <!--  Se da formato a la tabla y se asignan sus respectivas columnas-->
                        <td>Genero</td>
                        <td>Mujer</td>
                    </tr>
                </thead>
                <tbody>
                    ...
                    %>
                    <tr>
                        <td><%=p.obtenerEstados()%></td>
                        <td><%=p.obtenerGenero()%></td>
                        <td></td><!--Se imprimen los datos deseados mediante los getter-->
                    </tr>
                    <%
                    }%>
                </tbody>  
